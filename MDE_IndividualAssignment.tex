...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\begin{tabular}{l|p{10.5cm}}
			...
			Product placements & A technique where products or references are part of another work, such as a movie, tv program or youtube video with promotional intent.~\cite{productplacements} \\
			Promotions & Special offers and information are provided only to \textit{fans}, for example a discount for the first $x$ amount of customer.~\cite{socialmedia} \\
			Croud sourcing & \\ 
			Check-ins & \\
			Games & \\
			Media sharing sites & \\
