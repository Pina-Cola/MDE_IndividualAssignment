...
%-------------------------------------------------------------------------------------------	
	...
	The concepts of \textit{Scale}, \textit{Scope}, and \textit{Speed} can be used to explain how organizations become fast-movers. Those concepts are explained in Section \ref{sec:EffectsOfDigitalization}.
