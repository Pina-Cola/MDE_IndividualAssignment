...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		A challenge for company's that want to be fast-movers is the acceptance of new strategies within the company: Fast-movers have to adapt to new situations quickly and the
		TODO 
