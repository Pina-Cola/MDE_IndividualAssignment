...
%-------------------------------------------------------------------------------------------	
	...
	Speed is the most crucial element in becoming a fast mover, because the quick adaption to changes is crucial for being a fast-mover. \cite{fastmovers, digitalmatrix}
