...
%-------------------------------------------------------------------------------------------	
	...
	\begin{CountingDefinition}[Fast-mover]{def:fastmovers}
		Fast-movers refers to companies or organizations thatcan adapt quickly to changes in their environment, for example market shifts, technological developments or competitive pressures.
	\end{CountingDefinition}
