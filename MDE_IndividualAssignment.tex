...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\begin{tabular}{l|p{10.5cm}}
			...
			Tracking & Cookies or other mechanisms to check-in can be used to track user behavior, show personalized ads and measure the effectiveness of ad campaigns. \\
			Games & \\
			Media sharing sites & \\
			Voting sites & \\
			Review sites & \\
