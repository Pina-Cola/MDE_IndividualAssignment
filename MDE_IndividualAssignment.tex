...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\item 	\textit{\textbf{AI and automation}} can be used to automate routine tasks to reduce the workload on employees and to predicti and analyze processes. This can improve the efficiency and speed in various business operations.
