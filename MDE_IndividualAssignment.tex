...
%-------------------------------------------------------------------------------------------
	...
	The digitalization of business and organization has a big impact on companies, reshaping the way they operate and compete. These changes can be analyzed through the lens of \textit{Scale}, \textit{Scope}, and \textit{Speed}. \textit{Scale}, \textit{Scope} and \textit{Speed} are also referred to as the three dimensions of digital business.~\cite{digitalmatrix}
...
Companies extended their \textit{Scale} in the industrial era by increasing sales of products. This was limited by physical attributes such as reaching enough costumers. Digitalization enables companies to reach a gloibal market more easily.
