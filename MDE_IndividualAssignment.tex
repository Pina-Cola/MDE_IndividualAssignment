...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\begin{tabular}{l|p{11cm}}
			...
			Product placements & is a technique where products or references are part of another work, such as a movie, tv program or youtube video with promotional intent.~\cite{productplacements} \\
			Promitions & \\
			Croud sourcing & \\ 
			Check-ins & \\
			Games & \\
