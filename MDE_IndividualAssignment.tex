...
%-------------------------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\item \textit{\textbf{AI\footnote{\textit{AI} is short for Artificial Intelligence} and automation}} can be used to automate routine tasks to reduce the workload on employees and to predicti and analyze processes. This can improve the efficiency and speed in various business operations.~\cite{ai}
		
		\begin{tabular}{l|p{10.5cm}}
			
			AI & \cite{ai, ai2}\\
			
			Machine Learning & \cite{ai2}\\
