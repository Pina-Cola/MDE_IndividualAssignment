...
\begin{document}
	...
	\begin{CountingDefinition}[Scale]{def:scale}
		Scale describes the rate at which products are created. \cite{digitalmatrix, scalescopespeedslides}
	...
	\begin{CountingDefinition}[Scale]{def:scale1}
		Scale describes the rate at which products are created. \cite{digitalmatrix}
	\end{CountingDefinition}
