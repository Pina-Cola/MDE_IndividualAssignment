...
\begin{itemize}
	...
	If needed, new digital solutions should work without issues together with the existing legacy systems. After introducing a new digital solution, the employees could be trained in using it efficiently.~\cite{legacy, wiwi}
	
	
	
	
	\item \textbf{Cultural Resistance}: Incumbent organizations may have established cultures and traditions that resist change. To mitigate this challenge, they can implement change management strategies rooted in the literature, emphasizing the importance of adaptability and fostering a culture of innovation.
