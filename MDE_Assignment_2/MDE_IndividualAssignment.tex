...
\section{Key challenges for established companies} \label{sec:Sec2}
	...
	\begin{itemize}
		...
		Incumbent companies might not have the expertise in digital technologies in-house. 
		
		\begin{itemize}
			
			\item \textbf{Decisions on digital strategies}: 
			
			Companies must decide on and execute digital strategies.
			
			\item \textbf{Data security and privacy}: 
			
			Companies must ensure robust data security and privacy to protect customer information.
			
			\item \textbf{Performance}: 
			
			Digital solutions need to scale to meet increasing demands while maintaining performance.
		...
		Transitioning the existing customer base to new digital platforms or services can be challenging. They might be used to the traditional business model.
		
		
		\item \textbf{Financial aspects}: 
		
		Digital transformation projects can be expensive.
