...
% \subsection{Introduction of the authors} \label{subsec:authors}
	...
	\begin{CountingDefinition}[Authors of \textit{Leading digital}]{def:defdef2}
		...
		\end{minipage}	\begin{minipage}{0.7\linewidth}
			...
			Andrew McAfee is a principal research scientist at MIT and co-founder of the MIT Initiative on the Digital Economy. He has written numeral books, including \textit{Race Against the Machine}, \textit{The Second Machine Age} and \textit{Leading digital}. \cite{AM, leadingdigital}
