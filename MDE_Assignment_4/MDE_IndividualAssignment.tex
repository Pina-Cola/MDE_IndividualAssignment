...
%-------------------------------------------------------------------------------------------	
	...
	The main aspects of digital transformation are listed as automation, virtualization, improved targeted product and service customization, more informed decision making and machine-driven recommendations. Those technologies can be applied at almost every company and in almost every step of their processes.~\cite{disruptive}
...
In \textit{IT-enabled business transformation: from automation to business scope redefinition}~\cite{venkat} by Nramanujam Venkatraman was stated that digital tools have a distinctive role in shaping the future's business operations while being a fundamental enabler in creating and maintaining competitiveness.
...
The literature presented different interpretations and definitions of the process of digital transformation. Some sources emphasize the importance of incremental changes to improve existing processes and systems, sometimes even warning for the risks of digital transformation \cite{5myths, disruptive, venkat}.
Others connect digital transformation with a disruption that leads to a radical change in the traditional business model \cite{vial, DTOT}.
