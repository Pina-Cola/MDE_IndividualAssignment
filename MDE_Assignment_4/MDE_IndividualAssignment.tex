...
\subsection{\textit{Five myths about digital transformation}} \label{5myths}	
	...
	\begin{itemize}
		...
		\item if the company is already going well, the transformation will not have a meaningful impact
		\item disruptive transformation does usually not begin with the market leaders
		\item executives do not necessarily want to transform digitally 
	\end{itemize}
...
%-------------------------------------------------------------------------------------------	
\subsection{\textit{IT-enabled business transformation: from automation to business scope redefinition}} \label{venkat}	
